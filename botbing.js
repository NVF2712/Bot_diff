...
// @author       Shabunina Natalya
// @match        https://www.bing.com/*
// @match        https://www.botanichka.ru/*
...
let keywords = [
  ...
  "Лишайники", 
  "Древние технологии", 
  "Многолетние сидераты", 
 ];
let keyword = keywords[getRandom(0, keywords.length)];
let bingInput = document.getElementsByName("q")[0];

// Ищем на главной странице поисковика
if (search_button != undefined) {
...
} else if (location.hostname == "www.botanichka.ru") {
  ...
  setInterval(() => {
    ...
    if (links.length == 0) {
      location.href = "https://www.botanichka.ru/";
    } 
    else if (links[index].href.indexOf("www.botanichka.ru") != -1) {
  ...
  for (let i = 0; i < links.length; i++) {
    if (links[i].href.includes("www.botanichka.ru")) {
      let link = links[i];
      nextBingPage = false;
